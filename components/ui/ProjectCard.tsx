        ...
        <div className="flex justify-between items-center mt-20">
          {liveUrl ? (
            <CardItem
              ...
              className="px-4 py-2 rounded-xl text-xs font-normal dark:text-white hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors"
            >
              Live Demo →
            </CardItem>
          ) : (
            <div /> /* Keeps flex-between alignment if there is no live demo */
          )}
